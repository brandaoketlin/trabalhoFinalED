...
void le_producao(Producao *p); // para ler a producao
No* insere_lista_ordenado_data(No* li, Producao p); //inserir registro na lista de producao em ordem pela data
...
No* remove_lista(No* li, int codigo); //remove registro buscando pelo codigo tambem
void lista_todos(No* li); //mostrar todos os registros de producao na lista
void limpar_buffer_teclado(); // funcao para limpar o lixo do buffer do teclado
